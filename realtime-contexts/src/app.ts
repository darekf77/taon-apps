...
//#region realtime-contexts component
//#region @browser
@Component({
  selector: 'app-realtime-contexts',
  standalone: false,
  template: `hello from realtime-contexts<br />
...
export class RealtimeContextsComponent {
  angularVersion =
    VERSION.full +
...
//#region  realtime-contexts api service
//#region @browser
@Injectable({
  providedIn: 'root',
})
...
//#region  realtime-contexts module
//#region @browser
@NgModule({
  providers: [
    {
  ...
  exports: [RealtimeContextsComponent],
  imports: [
    CommonModule,
  ...
  declarations: [RealtimeContextsComponent],
})
export class RealtimeContextsModule {}
//#endregion
//#endregion

//#region  realtime-contexts entity
...
//#region  realtime-contexts controller
...
//#region  realtime-contexts migration
//#region @websql
@Taon.Migration({
...
//#region  realtime-contexts context
